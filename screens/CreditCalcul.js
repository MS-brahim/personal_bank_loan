...
export default class CreditCalcul extends React.Component {
  ...
  navigateToValid = async () => {
    let amortissement = this.calcAmortissment(
      this.state.amount,
      this.state.months
    );
      ...
      <ScrollView style={styles.title}>
        ...
        <View style={styles.container}>
          <View style={styles.slider}>
            <Text style={{ color: this.colors.white, fontWeight: "bold" }}>
              {this.min}
            </Text>
        ...
        <ButtonShared
          text="DEMANDER CE PRET"
          onPress={() => this.navigateToValid()}
        />
      </ScrollView>
    );
  }
